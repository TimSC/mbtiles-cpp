...
class Tile_Value : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile.Value) */ {
 public:
  Tile_Value();
  virtual ~Tile_Value();
...
class Tile_Feature : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile.Feature) */ {
 public:
  Tile_Feature();
...
class Tile_Layer : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile.Layer) */ {
 public:
  Tile_Layer();
  virtual ~Tile_Layer();
...
class Tile : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:vector_tile.Tile) */ {
 public:
  Tile();
  virtual ~Tile();
